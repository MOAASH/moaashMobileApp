  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
            ...
            <View style={{padding: 12, flexDirection: 'row' }}>
              <View>
                <CheckBox
                  ...
                  onValueChange={() => this.changeSelectedAddress(item.index, item.item.id)}
                  style={{ width: RFPercentage(2), height: RFPercentage(2) }}
                />
              </View>
              <View style={{ flex: 1, paddingLeft: 8 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  <Text style={{fontSize: RFValue(12), fontFamily: Fonts.regular }}>{item.item.attributes.customer_name}</Text>
                  {/* <Ionicons name="trash" size={20} /> */}
                </View>
                <View>
                  <Text style={{paddingVertical: 4, fontFamily: Fonts.regular, fontSize: RFValue(10), color: Colors.Gray}}>{item.item.attributes.address}</Text>
                  <Text style={{paddingVertical: 4, fontFamily: Fonts.regular, fontSize: RFValue(10), color: Colors.Gray}}>{item.item.attributes.phone_number}</Text>
                </View>
              </View>
            </View>
          )}/>
        ...
        <View style={{flexDirection: 'row', flex: 1, width: SCREEN_WIDTH, position: 'absolute', borderRadius: 5, bottom: 20}}>
          <TouchableOpacity
            style={{
              alignItems: 'center',
              borderWidth: 1,
            ...
            <Text style={{fontSize: RFValue(12), fontFamily: Fonts.regular, color: Colors.color2}}>Add New Address</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              alignItems: 'center',
