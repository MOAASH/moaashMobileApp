...
export default class OrderTotal extends Component {
  ...
  calculateTotalAmount = () => {
    return parseInt(this.props.totalAmount) + parseInt(this.props.shippingCharges);
  }
    ...
    return (
      <View
        ...
        <View
          ...
          <Text style={{fontSize: RFValue(10), fontFamily: Fonts.regular, color: Colors.Gray}}>Product Charges</Text>
        ...
        <View
          ...
          <Text style={{fontSize: RFValue(10), fontFamily: Fonts.regular, color: Colors.Gray}}>Shipping Charges</Text>
          <Text style={{fontSize: RFValue(10), fontFamily: Fonts.regular}}>PKR {this.props.shippingCharges}</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
          ...
          <Text style={{fontSize: RFValue(10), fontFamily: Fonts.regular, color: Colors.color1 }}>
            Order Total
          </Text>
          <Text style={{fontSize: RFValue(10), fontFamily: Fonts.regular, color: Colors.color1 }}>
